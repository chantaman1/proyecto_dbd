				...
				<div class="grid_6">
					...
					<form id="bookingForm" method="POST" action="{{ url('register/doRegister') }}">
						<div class="fl1">
							...
							<div class="tmInput">
								<input name="apellido_paterno" id="apellido_paterno" placeHolder="apellido paterno..." type="text" data-constraints="@NotEmpty @Required">
							</div>
              <div class="tmInput">
								<input name="apellido_materno" id="apellido_materno" placeHolder="apellido materno..." type="text" data-constraints="@NotEmpty @Required">
							</div>
						</div>
						<div class="clear"></div>
						<div id="bornDate">
							...
							<label class="tmDatepicker">
								<input type="text" id="fecha_nacimiento" name="fecha_nacimiento" placeHolder={{ date('m/d/Y') }} data-constraints="@NotEmpty @Required @Date">
							</label>
						</div>
            <div class="clear"></div>
            <div class="fl1">
							<div class="tmInput">
								<input name="direccion" id="direccion" placeHolder="Direccion..." type="text" data-constraints='@NotEmpty @Required @AlphaSpecial'>
							</div>
              <div class="tmInput">
								<input name="telefono" id="telefono" placeHolder="Telefono..." type="text" data-constraints='@NotEmpty @Required @AlphaSpecial'>
							</div>
              <div class="tmInput">
								<input name="nacionalidad" id="nacionalidad" placeHolder="nacionalidad..." type="text" data-constraints='@NotEmpty @Required @AlphaSpecial'>
							</div>
              <div class="tmInput">
								<input name="pasaporte" id="pasaporte" placeHolder="Pasaporte..." type="text" data-constraints='@NotEmpty @Required @AlphaSpecial'>
							</div>
              <div class="tmInput">
