				...
				<div class="card card-signin my-5">
					<div class="card-body">
						...
						<form class="form-signin" method="POST" action="{{ url('comprar') }}">
							...
							<div class="form-label-group">
								<input name="apellido_paterno" type="surname" id="inputSurname" class="form-control" placeholder="Father's surname" required>
								<label for="inputSurname">Apellido parterno</label>
							</div>
							<div class="form-label-group">
								<input name="apellido_materno" type="surname" id="inputSurname" class="form-control" placeholder="Mother's surname" required>
								<label for="inputSurname">Apellido materno</label>
							</div>
							<div class="form-label-group">
							...
							<div class="probootstrap-date-wrap">
								...
								<input name="fecha_nacimiento" type="text" id="probootstrap-date-departure" class="form-control" placeHolder={{ date('d/m/Y') }} data-constraints="@NotEmpty @Required @Date">
								<label for="inputAddress">Fecha de nacimiento</label>
							</div>
							<div class="form-label-group">
								<input name="direccion" type="address" id="inputAddress" class="form-control" placeholder="Address" required>
								<label for="inputAddress">Dirección</label>
							</div>
							<div class="form-label-group">
								<input name="telefono" type="phone" id="inputPhone" class="form-control" placeholder="Phone number" required>
								<label for="inputPhone">Teléfono</label>
							</div>
							<div class="form-label-group">
								<input name="pasaporte" type="passport" id="inputPassport" class="form-control" placeholder="Passport" required>
								<label for="inputPassport">Pasaporte</label>
							</div>
							<div class="form-group">
								<label for="id_label_single" style="width: 100%;">
									<select name="nacionalidad" class="js-example-basic-single js-states form-control" id="id_label_single" style="width: 100%;">
  ...
  <div class="col-md-6" style="margin-top:-6%">
    <div class="col-md">
        <form action="{{ url('finalizar_pago_habitacion') }}" class="probootstrap-form">
          <h5 class="card-title text-center">Buscar pasajero existente</h5>
          <div class="form-group">
            <div class="row mb-3">
              <div class="col-md">
                <div class="form-group">
