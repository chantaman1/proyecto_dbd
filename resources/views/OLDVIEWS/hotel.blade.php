			...
			<div class="container_12 offset-by-six">
				...
				<div class="grid_6">
					...
					<form id="bookingForm" action="{{ url('getHotels') }}">
						...
						<div class="fl1 fl2">
							<em>Adultos</em>
							<select type="integer" name="adults" class="tmSelect auto" data-class="tmSelect tmSelect2" data-constraints="">
								<option>1</option>
								<option>1</option>
								<option>2</option>
								<option>3</option>
						...
						<div class="fl1 fl2">
							<em>Niños</em>
							<select type="integer" name="children" class="tmSelect auto" data-class="tmSelect tmSelect2" data-constraints="">
								<option>0</option>
								<option>1</option>
								<option>2</option>
								<option>3</option>
