								...
								<form class="form-signin" method="POST" action="{{ url('administrationPaqueteDisable') }}">
									<div class="form-group">
										...
										<label for="id_label_single" style="width: 100%;">
											<select name="paqueteId" class="js-example-basic-single js-states form-control" id="id_label_sin" style="width: 100%;">
                    ...
                    <div class="form-label-group">
			              ...
			              <hr class="my-4">
								...
								<form class="form-signin" method="POST" action="{{ url('administrationPaqueteAdd') }}">
									<div class="form-label-group">
										<input name="price" type="name" id="inputName" class="form-control" placeholder="Package price" required autofocus>
										<label>Precio del paquete (Por persona)</label>
									</div>
                  <div class="form-label-group">
										<input name="discount" type="name" id="inputName" class="form-control" placeholder="Package discount" required autofocus>
										<label>Descuento del paquete (ej 15 = 15% descuento)</label>
									</div>
                  <div class="form-label-group">
										<input name="quota" type="name" id="inputName" class="form-control" placeholder="Package quota" required autofocus>
										<label>Cupos del paquete</label>
									</div>
                  <div class="form-group">
                    <label for="id_label_single" style="width: 100%;">
