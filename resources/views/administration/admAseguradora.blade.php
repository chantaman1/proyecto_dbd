		        ...
		        <div class="card card-signin my-5">
		          <div class="card-body">
		            <h5 class="card-title text-center">Administrar aseguradoras</h5>
								<form class="form-signin" method="POST" action="{{ url('administrationAseguradoraDisable') }}">
									<div class="form-group">
										<label for="id_label_single">Aseguradoras existentes</label>
                          ...
                          @if($aseguradora->activo)
													  <option value="{{ $aseguradora->id }}">{{ $aseguradora->nombre }} STATUS: Activo</option>
                          @else
                            <option value="{{ $aseguradora->id }}">{{ $aseguradora->nombre }} STATUS: Inactivo</option>
                          @endif
                        @endforeach
											</select>
										</label>
                    <div class="form-label-group">
										...
										<button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">Activar/desactivar aseguradora</button>
			              <hr class="my-4">
									</div>
								</form>
								<form class="form-signin" method="POST" action="{{ url('administrationAseguradoraAdd') }}">
									<div class="form-label-group">
										<input name="name" type="name" id="inputName" class="form-control" placeholder="insurance name" required autofocus>
										<label>Nombre de la aseguradora</label>
									</div>
                  <div class="form-label-group">
										<input name="address" type="name" id="inputName" class="form-control" placeholder="insurance address" required autofocus>
										<label>Dirección de la aseguradora</label>
									</div>
                  <div class="form-label-group">
										<input name="phone" type="name" id="inputName" class="form-control" placeholder="insurance phone" required autofocus>
										<label>Teléfono de la aseguradora</label>
									</div>
                  <div class="form-label-group">
										<input name="webpage" type="name" id="inputName" class="form-control" placeholder="insurance webpage" required autofocus>
										<label>Pagina web de la aseguradora</label>
									</div>
                  <div class="form-label-group">
										<input name="city" type="name" id="inputName" class="form-control" placeholder="insurance city" required autofocus>
										<label>Ciudad de la aseguradora</label>
									</div>
                  <div class="form-group">
										<label for="id_label_single" style="width: 100%;">
				                ...
				                <option value="Zimbabwe">Zimbabwe</option>
											...
											<label for="inputCountry">Pais de la aseguradora</label>
										</label>
									</div>
									<div class="form-label-group">
